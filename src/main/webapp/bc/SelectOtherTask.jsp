     ...
     $(document).ready(
            function(){
                        ...
                        success:function(data){
                            ...
                            if(data!=null){
                                for(var i=0;i<data.length;i++){
                                    ...
                                    if(step==1 && state==1){
                                        tr=tr+"<td>未自评</td>";
                                        tr=tr+"<td disabled>未评价</td>";
                                    }
                                    if(step==1 && state==2){
                                        tr=tr+"<td >已自评</td>";
                                        tr=tr+"<td><button class='tbstaffid'value='"+TbStaffId+"'>未评价</button>"+
                                            "<input style='display: none' class='tbtaskid' type='text' value='"+TbTaskId+"'></td>";
                                    }
                                    if(step==1 && state==3){
                                        tr=tr+"<td >未自评</td>";
                                        tr=tr+"<td><button class='tbstaffid'value='"+TbStaffId+"'>已评价</button>"+
                                            "<input style='display: none' class='tbtaskid' type='text' value='"+TbTaskId+"'></td>";
                                    }
                                    if(step==1 && state==4){
                                        tr=tr+"<td >已自评</td>";
                ...
                $("#tbody1").on("click",".tbstaffid",function(){
                    ...
                    window.location.href="${path}/bc/SelectTwoTbDetailone.jsp?TbStaffId="+TbStaffId+"&TbTaskId="+TbTaskId
                })
