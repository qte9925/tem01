            ...
            if(data!=null){
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    if(TbRecorddetailsState==1){
                        tr=tr+"<td><input style='border: 0px' type='text'  class='sumoneself' value='"+sumoneself+"'></td>";
                    }
    ...
    function leadership(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.state){
                    alert(data.state);
                    window.location.href="${path}/bc/SelectMyTask.jsp"
                }
            }
        });
    }
...
<body>
    ...
    <div style="display: block;width: 90%;  margin-left: 80px">
         <div width="100%" >
             <div width="100%" align="right"><button class="btn btn-default" id="leadership" onclick="leadership()">提交自评</button></div>
         </div>
    </div>
</body>
</html>
