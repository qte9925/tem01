                            ...
                            <table>
                               ...
                               <%-- <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="zcr" disabled="disabled">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="zcsj" disabled="disabled">
                                    </td>
                                </tr>
                            </table>
                        </center>
            ...
            success:function(data){
                ...
                if(data!=null){
                    for(var i=0;i<data.list.length;i++){
                        ...
                        tr=tr+"    <td><input type=\"button\" value='查看' onclick='aa("+st.id+")' class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#myModalc\"/></td>";
