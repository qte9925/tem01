        ...
        for (var i = 0; i < data.length; i++) {
            var p = data[i];
                var html = '<DIV style="position: absolute;" >' +
                    ...
                    '</DIV>' ;
                for(c01=0;c01<5;c01++){
                     html=html+'<DIV style="font-size:18px;" >' ;
                     for(c02=0;c02<7;c02++){
                         if(c01==0){
                             html=html+'<DIV class="div02" style="font-size:18px;"  ><p>'+data[c02+a].DAY_LONG_DESC+'</p>';
                             if(data[c02+a].sfgz==0){
                                 html=html+'<p style="margin-top: -30px;" >工作日</p>';
                             }
                             if(data[c02+a].sfgz==1){
                                 html=html+'<p >非工作日</p>';
                             }
                             if(data[c02+a].gzsjid==1){
                                 html=html+'<p>上午工作时间：'+data[c02+a].swsbsj+' -- '+data[c02+a].swxbsj+'下午工作时间：'+data[c02+a].xwsbsj+' -- '+data[c02+a].xwxbsj+'</p>';
                             }
                         ...
                         if(c01==1){
                             ...
                             if(data[c02+b].gzsjid==1){
                                 html=html+'<p>上午工作时间：'+data[c02+b].swsbsj+' -- '+data[c02+b].swxbsj+'下午工作时间：'+data[c02+b].xwsbsj+' -- '+data[c02+b].xwxbsj+'</p>';
                             }
                         ...
                         if(c01==2){
                             ...
                             if(data[c02+c].gzsjid==1){
                                 html=html+'<p>上午工作时间：'+data[c02+c].swsbsj+' -- '+data[c02+c].swxbsj+'下午工作时间：'+data[c02+c].xwsbsj+' -- '+data[c02+c].xwxbsj+'</p>';
                             }
                         ...
                         if(c01==3){
                             ...
                             if(data[c02+d].gzsjid==1){
                                 html=html+'<p>上午工作时间：'+data[c02+d].swsbsj+' -- '+data[c02+d].swxbsj+'下午工作时间：'+data[c02+d].xwsbsj+' -- '+data[c02+d].xwxbsj+'</p>';
                             }
                         ...
                         if(c01==4){
                             ...
                             if(c02+e<data.length){
                                 ...
                                 if(data[c02+e].gzsjid==1){
                                     html=html+'<p>上午工作时间：'+data[c02+e].swsbsj+' -- '+data[c02+e].swxbsj+'下午工作时间：'+data[c02+e].xwsbsj+' -- '+data[c02+e].xwxbsj+'</p>';
                                 }
