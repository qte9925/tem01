                    ...
                    <table class="table table-bordered" style="margin-left: 20px;" >
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="col-sm-10">
                                    <input id="huji" class="form-control" readonly type="text" data-toggle="city-picker">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <div class="col-sm-10">
                                    <input id="xianjudi" class="form-control" readonly type="text" data-toggle="city-picker">
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="col-sm-10">
                                    <input id="qwdd" class="form-control" readonly type="text" data-toggle="city-picker">
                                </div>
                            </td>
                        </tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="button" class="btn btn-default" onclick="insert_wf_jianli();">保存</button>
