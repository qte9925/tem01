...
<table class="table table-bordered" style="margin-left: 20px;" >
    ...
    <tbody id="thead01">
        <tr v-for="i in msg" v-if="i.qjzt==4||i.qjzt==1">
            <td v-if="i.qjzt==1" >请假</td>
            <td v-if="i.qjzt==4" >出差</td>
            ...
            <%--<td>--%>
                ...
                <%--&nbsp;&nbsp;--%>
                <%--<button  v-if="i.tianshu>3 && i.qjzt==0" >--%>
                    <%--<a href="javascript:aa01('{{i.qjid}}',0)">通过</a>--%>
                <%--</button>--%>
                <%--&nbsp;&nbsp;--%>
                ...
                <%--&nbsp;&nbsp;--%>
                <%--<button  v-if="i.tianshu>3 && i.qjzt==3" >--%>
                    <%--<a href="javascript:aa01('{{i.qjid}}',3)">通过</a>--%>
                <%--</button>--%>
                <%--&nbsp;&nbsp;--%>
